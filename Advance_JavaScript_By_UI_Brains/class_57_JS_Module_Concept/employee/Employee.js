...
export class Employee extends Person{
  ...
  constructor(firstName,lastName,age,designation){//constructor with parameter and initialize with the instance variable /local property/variable
    ...
    this.designation=designation//initialize with the instance variable /local property/variable
  }
  ...
  getDesignation(){//getter method with out the function keyword
